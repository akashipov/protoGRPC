...
type Params struct {
	...
	F int64 `protobuf:"varint,1,opt,name=F,proto3" json:"F,omitempty"`
...
func (x *ChangedParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangedParams) ProtoMessage() {}

func (x *ChangedParams) ProtoReflect() protoreflect.Message {
	mi := &file_protoapi_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangedParams.ProtoReflect.Descriptor instead.
func (*ChangedParams) Descriptor() ([]byte, []int) {
	return file_protoapi_proto_rawDescGZIP(), []int{1}
}

func (x *ChangedParams) GetF() int64 {
	if x != nil {
		return x.F
	}
	return 0
...
func (x *ChangedParams) GetS() int64 {
	if x != nil {
		return x.S
	}
	return 0
...
func (x *ChangedParams) GetM() string {
	if x != nil {
		return x.M
	}
	return ""
...
var file_protoapi_proto_rawDesc = []byte{
	...
	,
...
var file_protoapi_proto_goTypes = []interface{}{
	(*Params)(nil),        // 0: Params
	(*ChangedParams)(nil), // 1: ChangedParams
}
var file_protoapi_proto_depIdxs = []int32{
	0, // 0: TimeChanger.GetParams:input_type -> Params
	1, // 1: TimeChanger.GetParams:output_type -> ChangedParams
